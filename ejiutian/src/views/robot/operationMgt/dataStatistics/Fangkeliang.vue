    ...
    <div class="p" ref = "p">
        ...
        <div class="sector sector1">
            <jt-row class="wrapper-row" type="flex" justify="space-between">
                <jt-col :span='10'>
                    <span class='traffic'>访客量（UV）</span>
                    <!-- <span class='cumulative'>累计访客量</span>
                ...
                <jt-col :span='14'>
                    <jt-row  type="flex" justify="end">
                        ...
                        <jt-col>
                            <jt-range-picker @change="onChange" :value="value2" :format='dateFormat' style="width: 200px;">
            ...
            <div id="main4" v-show="userfangke" style="width: 100%;height:300px;background:rgba(255,255,255,1);margin:6px"></div>
            <div class="table-type-3" v-show="!userfangke" style="height:300px;">
                <jt-empty :image="emptyImage" :imageStyle="{ margin:'0 auto',width:'64px',height:'40px',color:'#999999'}">
...
export default {
    ...
    methods: {
        ...mapActions({
            fangkeGet: "shujutongji/fangkeGet"
        }),
        initPage() {
            // this.fangkeGet();
            this.tablefangke = this.$store.state.shujutongji.tablefangke;
            this.tablefangkeheng = this.$store.state.shujutongji.tablefangkeheng;
            if (this.tablefangke.length>0){
                this.userfangke = true
            }else{
                this.userfangke = false
            }
            
            // console.log(this.tablefangkeheng)
            console.log("eeeeeee")
            
            // console.log(this.$store.state.shujutongji.tablefangke)
        },
        moment,
        onChange(date, dateString) {
            ...
            this.fangkeGet(param).then(() =>{
                this.initPage();
                console.log(dateString);
                if (dateString[0] == dateString[1] ){
                    // this.picker='day'
                    this.tablefangkeheng=["00:00","01:00", "02:00", "03:00", "04:00", "05:00", "06:00", "07:00", "08:00", "09:00", "10:00", "11:00", "12:00", "13:00","14:00", "15:00", "16:00", "17:00", "18:00", "19:00", "20:00", "21:00", "22:00", "23:59"]
                    console.log("///////////")
                }
        ...
        option(picker) {
            ...
            if (picker === "month") {
                ...
                // this.value2.push(
                //     moment(new Date(start.setTime(start.getTime() - 3600 * 1000 * 24 * 30)).format("yyyy/MM/dd"),this.dateFormat)
                // );
                // this.value2.push(
                //     moment(new Date(end.setTime(end.getTime()-3600 * 1000 * 24 * 1)).format("yyyy/MM/dd"),this.dateFormat)
                // );
        ...
        myEcharts() {
            ...
            const day1 = Math.floor(parseInt(this.tablefangkeheng.length)/6)
            const length = this.tablefangkeheng.length
            const option = {
                tooltip: {
                ...
                series: [
                    {
                        ...
                        data: this.tablefangke,
                        //data: this.$store.state.shujutongji.tablefangke,
                        type: "line",
                        smooth: true,
                        symbol: 'circle',
                        showSymbol:false,
                            ...
                            label: {
                                ...
                                formatter: function (params) {
                                    if(condition == 'day'){
                                        ...
                                        if(preTime!=23) {
                                            preTime = preTime+':59';
                                            period = params.name+'-'+preTime;
                                        }else{
                                            preTime = preTime+':00';
                                            period = preTime+'-'+params.name;
                                        }
                                        return '访客量(uv)   '+params.value+'\n'+period
                                    }else{
                                        return '访客量(uv)   '+params.value+'\n'+params.name
                                    }
                                },
